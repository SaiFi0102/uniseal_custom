...
frappe.query_reports["Visit Plan Completion Rate"] = {
	filters: [
		{
			label: __("Year"),
			fieldname: "year",
	...
	onload: function() {
		return  frappe.call({
			method: "uniseal_custom.uniseal_custom.report.visit_plan_completion_rate.visit_plan_completion_rate.get_years",
			callback: function(r) {
